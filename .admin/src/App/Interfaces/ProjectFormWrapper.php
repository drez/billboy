...
/**
 * Skeleton subclass for representing a services for the ProjectForm entity.
 *
 * User
 *
 ...
 */
class ProjectFormWrapper extends ProjectForm
{
    ...
    **/
    ...
    public function afterFormObj( array $data, Project &$dataObj)
    {
    }
}
