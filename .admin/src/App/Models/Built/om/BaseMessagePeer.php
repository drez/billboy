...
abstract class BaseMessagePeer
{
    ...
    const OM_CLASS = 'App\\Message';

    /** the related TableMap class for this table */
    const TM_CLASS = 'App\\map\\MessageTableMap';
    ...
    const ID_MESSAGE = 'message.id_message';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdMessage', 'Label', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idMessage', 'label', ),
        BasePeer::TYPE_COLNAME => array (MessagePeer::ID_MESSAGE, MessagePeer::LABEL, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_MESSAGE', 'LABEL', ),
        BasePeer::TYPE_FIELDNAME => array ('id_message', 'label', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdMessage' => 0, 'Label' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idMessage' => 0, 'label' => 1, ),
        BasePeer::TYPE_COLNAME => array (MessagePeer::ID_MESSAGE => 0, MessagePeer::LABEL => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_MESSAGE' => 0, 'LABEL' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id_message' => 0, 'label' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MessagePeer::ID_MESSAGE);
            $criteria->addSelectColumn(MessagePeer::LABEL);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseMessagePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \App\map\MessageTableMap());
      }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(MessagePeer::ID_MESSAGE) && $criteria->keyContainsValue(MessagePeer::ID_MESSAGE) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(MessagePeer::ID_MESSAGE);
            $value = $criteria->remove(MessagePeer::ID_MESSAGE);
            if ($value) {
                $selectCriteria->add(MessagePeer::ID_MESSAGE, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MessagePeer::ID_MESSAGE, (array) $values, Criteria::IN);
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(MessagePeer::LABEL))
            $columns[MessagePeer::LABEL] = $obj->getLabel();
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(MessagePeer::DATABASE_NAME);
        $criteria->add(MessagePeer::ID_MESSAGE, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(MessagePeer::DATABASE_NAME);
            $criteria->add(MessagePeer::ID_MESSAGE, $pks, Criteria::IN);
