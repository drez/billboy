...
/**
 * Base class that represents a row from the 'billing_line' table.
 *
 * Entries
 *
 * @package    propel.generator..om
 */
abstract class BaseBillingLine extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'App\\BillingLinePeer';
    ...
    /**
     * The value for the id_billing_line field.
     * @var        int
     */
    protected $id_billing_line;
    ...
    /**
     * The value for the work_date field.
     * @var        string
     */
    protected $work_date;
    ...
    /**
     * @Field()
     * Get the [id_billing_line] column value.
     *
     * @return int
     */
    public function getIdBillingLine()
    {

        return $this->id_billing_line;
    }
    ...
    /**
     * @Field()
     * Get the [optionally formatted] temporal [work_date] column value.
     * Date
     *
     ...
     */
    public function getWorkDate($format = 'Y-m-d')
    {
        if ($this->work_date === null) {
            return null;
        }

        if ($this->work_date === '0000-00-00') {
        ...
        try {
            $dt = new DateTime($this->work_date);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->work_date, true), $x);
        }
    ...
    /**
     * Set the value of [id_billing_line] column.
     *
     * @param  int $v new value
     * @return BillingLine The current object (for fluent API support)
     */
    public function setIdBillingLine($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->id_billing_line !== $v) {
            $this->id_billing_line = $v;
            $this->modifiedColumns[] = BillingLinePeer::ID_BILLING_LINE;
        }
    ...
    public function setIdBilling($v)
    {
        ...
        if ($this->id_billing !== $v) {
            $this->id_billing = $v;
            $this->modifiedColumns[] = BillingLinePeer::ID_BILLING;
        }
    ...
    public function setCalcId($v)
    {
        ...
        if ($this->calc_id !== $v) {
            $this->calc_id = $v;
            $this->modifiedColumns[] = BillingLinePeer::CALC_ID;
        }
    ...
    public function setIdProject($v)
    {
        ...
        if ($this->id_project !== $v) {
            $this->id_project = $v;
            $this->modifiedColumns[] = BillingLinePeer::ID_PROJECT;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = BillingLinePeer::TITLE;
        }
    ...
    /**
     * Sets the value of [work_date] column to a normalized version of the date/time value specified.
     * Date
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return BillingLine The current object (for fluent API support)
     */
    public function setWorkDate($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->work_date !== null || $dt !== null) {
            $currentDateAsString = ($this->work_date !== null && $tmpDt = new DateTime($this->work_date)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->work_date = $newDateAsString;
                $this->modifiedColumns[] = BillingLinePeer::WORK_DATE;
            }
    ...
    public function setQuantity($v)
    {
        ...
        if ($this->quantity !== $v) {
            $this->quantity = $v;
            $this->modifiedColumns[] = BillingLinePeer::QUANTITY;
        }
    ...
    public function setAmount($v)
    {
        ...
        if ($this->amount !== $v) {
            $this->amount = $v;
            $this->modifiedColumns[] = BillingLinePeer::AMOUNT;
        }
    ...
    public function setTotal($v)
    {
        ...
        if ($this->total !== $v) {
            $this->total = $v;
            $this->modifiedColumns[] = BillingLinePeer::TOTAL;
        }
    ...
    public function setNoteBillingLigne($v)
    {
        ...
        if ($this->note_billing_ligne !== $v) {
            ...
            $this->modifiedColumns[] = BillingLinePeer::NOTE_BILLING_LIGNE;
        }
    ...
    public function setDateCreation($v)
    {
        ...
        if ($this->date_creation !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BillingLinePeer::DATE_CREATION;
            }
        } // if either are not null
    ...
    public function setDateModification($v)
    {
        ...
        if ($this->date_modification !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = BillingLinePeer::DATE_MODIFICATION;
            }
        } // if either are not null
    ...
    public function setIdGroupCreation($v)
    {
        ...
        if ($this->id_group_creation !== $v) {
            ...
            $this->modifiedColumns[] = BillingLinePeer::ID_GROUP_CREATION;
        }
    ...
    public function setIdCreation($v)
    {
        ...
        if ($this->id_creation !== $v) {
            $this->id_creation = $v;
            $this->modifiedColumns[] = BillingLinePeer::ID_CREATION;
        }
    ...
    public function setIdModification($v)
    {
        ...
        if ($this->id_modification !== $v) {
            ...
            $this->modifiedColumns[] = BillingLinePeer::ID_MODIFICATION;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = BillingLinePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = BillingLineQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BillingLinePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(BillingLinePeer::ID_BILLING_LINE)) {
            $modifiedColumns[':p' . $index++]  = '`id_billing_line`';
        }
        if ($this->isColumnModified(BillingLinePeer::ID_BILLING)) {
            $modifiedColumns[':p' . $index++]  = '`id_billing`';
        }
        if ($this->isColumnModified(BillingLinePeer::CALC_ID)) {
            $modifiedColumns[':p' . $index++]  = '`calc_id`';
        }
        if ($this->isColumnModified(BillingLinePeer::ID_ASSIGN)) {
            $modifiedColumns[':p' . $index++]  = '`id_assign`';
        }
        if ($this->isColumnModified(BillingLinePeer::ID_PROJECT)) {
            $modifiedColumns[':p' . $index++]  = '`id_project`';
        }
        if ($this->isColumnModified(BillingLinePeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`title`';
        }
        if ($this->isColumnModified(BillingLinePeer::WORK_DATE)) {
            $modifiedColumns[':p' . $index++]  = '`work_date`';
        }
        if ($this->isColumnModified(BillingLinePeer::QUANTITY)) {
            $modifiedColumns[':p' . $index++]  = '`quantity`';
        }
        if ($this->isColumnModified(BillingLinePeer::AMOUNT)) {
        ...
        if ($this->isColumnModified(BillingLinePeer::DATE_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_creation`';
        }
        if ($this->isColumnModified(BillingLinePeer::DATE_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`date_modification`';
        }
        if ($this->isColumnModified(BillingLinePeer::ID_GROUP_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_group_creation`';
        }
        if ($this->isColumnModified(BillingLinePeer::ID_CREATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_creation`';
        }
        if ($this->isColumnModified(BillingLinePeer::ID_MODIFICATION)) {
            $modifiedColumns[':p' . $index++]  = '`id_modification`';
        }

        $sql = sprintf(
            'INSERT INTO `billing_line` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id_billing_line`':
                        $stmt->bindValue($identifier, $this->id_billing_line, PDO::PARAM_INT);
                        break;
                    case '`id_billing`':
                    ...
                    case '`title`':
                        ...
                        break;
                    case '`work_date`':
                        $stmt->bindValue($identifier, $this->work_date, PDO::PARAM_STR);
                        break;
                    case '`quantity`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = BillingLinePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = BillingLinePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['BillingLine'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['BillingLine'][$this->getPrimaryKey()] = true;
        $keys = BillingLinePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdBillingLine(),
            $keys[1] => $this->getIdBilling(),
            $keys[2] => $this->getCalcId(),
            $keys[3] => $this->getIdAssign(),
            $keys[4] => $this->getIdProject(),
            $keys[5] => $this->getTitle(),
            $keys[6] => $this->getWorkDate(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BillingLinePeer::ID_BILLING_LINE)) $criteria->add(BillingLinePeer::ID_BILLING_LINE, $this->id_billing_line);
        if ($this->isColumnModified(BillingLinePeer::ID_BILLING)) $criteria->add(BillingLinePeer::ID_BILLING, $this->id_billing);
        if ($this->isColumnModified(BillingLinePeer::CALC_ID)) $criteria->add(BillingLinePeer::CALC_ID, $this->calc_id);
        if ($this->isColumnModified(BillingLinePeer::ID_ASSIGN)) $criteria->add(BillingLinePeer::ID_ASSIGN, $this->id_assign);
        if ($this->isColumnModified(BillingLinePeer::ID_PROJECT)) $criteria->add(BillingLinePeer::ID_PROJECT, $this->id_project);
        if ($this->isColumnModified(BillingLinePeer::TITLE)) $criteria->add(BillingLinePeer::TITLE, $this->title);
        if ($this->isColumnModified(BillingLinePeer::WORK_DATE)) $criteria->add(BillingLinePeer::WORK_DATE, $this->work_date);
        ...
        if ($this->isColumnModified(BillingLinePeer::ID_GROUP_CREATION)) $criteria->add(BillingLinePeer::ID_GROUP_CREATION, $this->id_group_creation);
        if ($this->isColumnModified(BillingLinePeer::ID_CREATION)) $criteria->add(BillingLinePeer::ID_CREATION, $this->id_creation);
        if ($this->isColumnModified(BillingLinePeer::ID_MODIFICATION)) $criteria->add(BillingLinePeer::ID_MODIFICATION, $this->id_modification);
    ...
    {
        $criteria = new Criteria(BillingLinePeer::DATABASE_NAME);
        $criteria->add(BillingLinePeer::ID_BILLING_LINE, $this->id_billing_line);
    ...
    {
        return $this->getIdBillingLine();
    }

    /**
     * Generic method to set the primary key (id_billing_line column).
     *
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdBillingLine();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of BillingLine (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setWorkDate($this->getWorkDate());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdBillingLine(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return BillingLine Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return BillingLinePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new BillingLinePeer();
        }
    ...
    public function getBilling(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aBilling === null && ($this->id_billing !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aBilling->addBillingLines($this);
             */
        }
    ...
    public function setAuthyRelatedByIdAssign(Authy $v = null)
    {
        ...
        if ($v !== null) {
            $v->addBillingLineRelatedByIdAssign($this);
        }
    ...
    public function getAuthyRelatedByIdAssign(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdAssign === null && ($this->id_assign !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdAssign->addBillingLinesRelatedByIdAssign($this);
             */
        }
    ...
    public function getProject(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProject === null && ($this->id_project !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProject->addBillingLines($this);
             */
        }
    ...
    public function getAuthyGroup(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyGroup === null && ($this->id_group_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyGroup->addBillingLines($this);
             */
        }
    ...
    public function setAuthyRelatedByIdCreation(Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addBillingLineRelatedByIdCreation($this);
        }
    ...
    public function getAuthyRelatedByIdCreation(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdCreation === null && ($this->id_creation !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdCreation->addBillingLinesRelatedByIdCreation($this);
             */
        }
    ...
    public function setAuthyRelatedByIdModification(Authy $v = null)
    {
        ...
        // If this object has already been added to the Authy object, it will not be re-added.
        if ($v !== null) {
            $v->addBillingLineRelatedByIdModification($this);
        }
    ...
    public function getAuthyRelatedByIdModification(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAuthyRelatedByIdModification === null && ($this->id_modification !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAuthyRelatedByIdModification->addBillingLinesRelatedByIdModification($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(BillingLinePeer::DEFAULT_STRING_FORMAT);
    }
