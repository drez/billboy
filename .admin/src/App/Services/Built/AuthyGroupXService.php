...
class AuthyGroupXService
{
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = AuthyGroupXQuery::create()->findPk(json_decode($this->request['i']));
    ...
    public function saveUpdate()
    {
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setCreateDefaultsAuthyGroupX($data);
    ...
    */
    ...
    {
        $this->AuthyGroupX['request'] = $this->request;
        $this->AuthyGroupX['parentId'] = $this->request['data']['ip'];
