        ...
        if($Template){
            ...
            $disclaimer = div(
                ul(
                    ...
                    .li("Amounts are in US dollars")
                    .li("Any additional work requested not covered in the original brief will be quoted separately and added to the original invoice")
