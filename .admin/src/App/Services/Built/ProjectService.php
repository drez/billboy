...
class ProjectService
{
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = ProjectQuery::create()->findPk(json_decode($this->request['i']));


            if($obj->countBillings()){
                $error = handleNotOkResponse(_("This entry cannot be deleted. It is in use in ")." 'Billing'. ", '', true,'Project'); die( $error['onReadyJs'] );
            }
    ...
    public function saveUpdate()
    {
        ...
        $data['i'] = ( $data['IdProject'] ) ? $data['IdProject'] : $this->request['i'];
        $data['ip'] = urldecode($this->request['data']['ip']);
        $data['pc'] = urldecode($this->request['data']['pc']);
        $this->Project['request'] = $this->request;

        if(!empty($data['i'])) {
            ## Save

            $e = $this->Form->setUpdateDefaultsProject($data);
            ...
            $e = $this->Form->setCreateDefaultsProject($data);
    ...
    */
    ...
    {
        $this->Project['request'] = $this->request;
        $this->Project['parentId'] = $this->request['data']['ip'];
