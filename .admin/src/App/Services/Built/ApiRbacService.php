...
class ApiRbacService
{
    ...
    public function getResponse()
    {
        ...
        switch($this->request['a']){
            ...
            case 'delete':
                ...
                **/
                case 'ApiLog':
                    $this->content = $this->Form->getApiLogList($this->request['i'], $this->request);
                break;
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = ApiRbacQuery::create()->findPk(json_decode($this->request['i']));
    ...
    public function saveUpdate()
    {
        ...
        $data['i'] = ( $data['IdApiRbac'] ) ? $data['IdApiRbac'] : $this->request['i'];
        $data['ip'] = urldecode($this->request['data']['ip']);
        $data['pc'] = urldecode($this->request['data']['pc']);
        $this->ApiRbac['request'] = $this->request;

        if(!empty($data['i'])) {
            ## Save

            $e = $this->Form->setUpdateDefaultsApiRbac($data);
            ...
            $e = $this->Form->setCreateDefaultsApiRbac($data);
    ...
    */
    ...
    {
        $this->ApiRbac['request'] = $this->request;
        $this->ApiRbac['parentId'] = $this->request['data']['ip'];
