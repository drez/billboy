...
class PaymentLineService
{
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = PaymentLineQuery::create()->findPk(json_decode($this->request['i']));
    ...
    public function saveUpdate()
    {
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setCreateDefaultsPaymentLine($data);
    ...
    */
    ...
    {
        $this->PaymentLine['request'] = $this->request;
        $this->PaymentLine['parentId'] = $this->request['data']['ip'];
