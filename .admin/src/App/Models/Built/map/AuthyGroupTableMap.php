...
class AuthyGroupTableMap extends TableMap
{
  ...
  1 => 'Yes',
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Client', 'App\\Client', RelationMap::ONE_TO_MANY, array('id_authy_group' => 'id_group_creation', ), null, null, 'Clients');
        $this->addRelation('Billing', 'App\\Billing', RelationMap::ONE_TO_MANY, array('id_authy_group' => 'id_group_creation', ), null, null, 'Billings');
        $this->addRelation('BillingLine', 'App\\BillingLine', RelationMap::ONE_TO_MANY, array('id_authy_group' => 'id_group_creation', ), null, null, 'BillingLines');
        $this->addRelation('PaymentLine', 'App\\PaymentLine', RelationMap::ONE_TO_MANY, array('id_authy_group' => 'id_group_creation', ), null, null, 'PaymentLines');
        ...
        $this->addRelation('Currency', 'App\\Currency', RelationMap::ONE_TO_MANY, array('id_authy_group' => 'id_group_creation', ), null, null, 'Currencies');
