...
class TemplateService
{
    ...
    public function getResponse()
    {
        ...
        switch($this->request['a']){
            ...
            case 'delete':
                ...
                **/
                case 'TemplateFile':
                    $this->content = $this->Form->getTemplateFileList($this->request['i'], $this->request);
                break;
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = TemplateQuery::create()->findPk(json_decode($this->request['i']));
    ...
    public function saveUpdate()
    {
        ...
        $data['i'] = ( $data['IdTemplate'] ) ? $data['IdTemplate'] : $this->request['i'];
        ...
        if(!empty($data['i'])) {
            ...
            $e = $this->Form->setUpdateDefaultsTemplate($data);
            ...
            $e = $this->Form->setCreateDefaultsTemplate($data);
    ...
    */
    ...
    {
        $this->Template['request'] = $this->request;
        $this->Template['parentId'] = $this->request['data']['ip'];
