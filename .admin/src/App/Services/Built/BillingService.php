...
class BillingService
{
    ...
    public function getResponse()
    {
        ...
        switch($this->request['a']){
            ...
            case 'delete':
                ...
                **/
                case 'PaymentLine':
                    $this->content = $this->Form->getPaymentLineList($this->request['i'], $this->request);
                break;
    ...
    */
    ...
    public function saveUpdate()
    {
        ...
        $data['i'] = ( $data['IdBilling'] ) ? $data['IdBilling'] : $this->request['i'];
        $data['ip'] = urldecode($this->request['data']['ip']);
        $data['pc'] = urldecode($this->request['data']['pc']);
        $this->Billing['request'] = $this->request;
    ...
    */
    ...
    {
        $this->Billing['request'] = $this->request;
        $this->Billing['parentId'] = $this->request['data']['ip'];

            if($this->request['data']['ip']){
                $relData['IdClient'] = $this->request['data']['ip'];
