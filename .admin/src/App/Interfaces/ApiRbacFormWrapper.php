...
/**
 * Skeleton subclass for representing a services for the ApiRbacForm entity.
 *
 * User
 *
 ...
 */
class ApiRbacFormWrapper extends ApiRbacForm
{
    ...
    **/
    ...
    public function afterFormObj( array $data, ApiRbac &$dataObj)
    {
    }
}
