...
abstract class BaseCurrencyPeer
{
    ...
    const OM_CLASS = 'App\\Currency';

    /** the related TableMap class for this table */
    const TM_CLASS = 'App\\map\\CurrencyTableMap';
    ...
    const DATE_CREATION = 'currency.date_creation';

    /** the column name for the date_modification field */
    const DATE_MODIFICATION = 'currency.date_modification';

    /** the column name for the id_group_creation field */
    const ID_GROUP_CREATION = 'currency.id_group_creation';

    /** the column name for the id_creation field */
    const ID_CREATION = 'currency.id_creation';

    /** the column name for the id_modification field */
    const ID_MODIFICATION = 'currency.id_modification';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('IdCurrency', 'Name', 'DateCreation', 'DateModification', 'IdGroupCreation', 'IdCreation', 'IdModification', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCurrency', 'name', 'dateCreation', 'dateModification', 'idGroupCreation', 'idCreation', 'idModification', ),
        BasePeer::TYPE_COLNAME => array (CurrencyPeer::ID_CURRENCY, CurrencyPeer::NAME, CurrencyPeer::DATE_CREATION, CurrencyPeer::DATE_MODIFICATION, CurrencyPeer::ID_GROUP_CREATION, CurrencyPeer::ID_CREATION, CurrencyPeer::ID_MODIFICATION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_CURRENCY', 'NAME', 'DATE_CREATION', 'DATE_MODIFICATION', 'ID_GROUP_CREATION', 'ID_CREATION', 'ID_MODIFICATION', ),
        BasePeer::TYPE_FIELDNAME => array ('id_currency', 'name', 'date_creation', 'date_modification', 'id_group_creation', 'id_creation', 'id_modification', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('IdCurrency' => 0, 'Name' => 1, 'DateCreation' => 2, 'DateModification' => 3, 'IdGroupCreation' => 4, 'IdCreation' => 5, 'IdModification' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idCurrency' => 0, 'name' => 1, 'dateCreation' => 2, 'dateModification' => 3, 'idGroupCreation' => 4, 'idCreation' => 5, 'idModification' => 6, ),
        BasePeer::TYPE_COLNAME => array (CurrencyPeer::ID_CURRENCY => 0, CurrencyPeer::NAME => 1, CurrencyPeer::DATE_CREATION => 2, CurrencyPeer::DATE_MODIFICATION => 3, CurrencyPeer::ID_GROUP_CREATION => 4, CurrencyPeer::ID_CREATION => 5, CurrencyPeer::ID_MODIFICATION => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID_CURRENCY' => 0, 'NAME' => 1, 'DATE_CREATION' => 2, 'DATE_MODIFICATION' => 3, 'ID_GROUP_CREATION' => 4, 'ID_CREATION' => 5, 'ID_MODIFICATION' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id_currency' => 0, 'name' => 1, 'date_creation' => 2, 'date_modification' => 3, 'id_group_creation' => 4, 'id_creation' => 5, 'id_modification' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CurrencyPeer::ID_CURRENCY);
            $criteria->addSelectColumn(CurrencyPeer::NAME);
            $criteria->addSelectColumn(CurrencyPeer::DATE_CREATION);
            $criteria->addSelectColumn(CurrencyPeer::DATE_MODIFICATION);
            $criteria->addSelectColumn(CurrencyPeer::ID_GROUP_CREATION);
            $criteria->addSelectColumn(CurrencyPeer::ID_CREATION);
            $criteria->addSelectColumn(CurrencyPeer::ID_MODIFICATION);
        } else {
    ...
    public static function doCountJoinAuthyGroup(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CurrencyPeer::ID_GROUP_CREATION, AuthyGroupPeer::ID_AUTHY_GROUP, $join_behavior);
    ...
    public static function doCountJoinAuthyRelatedByIdCreation(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CurrencyPeer::ID_CREATION, AuthyPeer::ID_AUTHY, $join_behavior);
    ...
    public static function doCountJoinAuthyRelatedByIdModification(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CurrencyPeer::ID_MODIFICATION, AuthyPeer::ID_AUTHY, $join_behavior);
    ...
    /**
     * Selects a collection of Currency objects pre-filled with their AuthyGroup objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAuthyGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Currency) to $obj2 (AuthyGroup)
    ...
    /**
     * Selects a collection of Currency objects pre-filled with their Authy objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Currency objects.
    ...
    public static function doSelectJoinAuthyRelatedByIdCreation(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Currency) to $obj2 (Authy)
                $obj2->addCurrencyRelatedByIdCreation($obj1);
    ...
    public static function doSelectJoinAuthyRelatedByIdModification(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Currency) to $obj2 (Authy)
                $obj2->addCurrencyRelatedByIdModification($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Currency) to the collection in $obj2 (AuthyGroup)
                $obj2->addCurrency($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Currency) to the collection in $obj3 (Authy)
                $obj3->addCurrencyRelatedByIdCreation($obj1);
            } // if joined row not null
            ...
            if ($key4 !== null) {
                ...
                // Add the $obj1 (Currency) to the collection in $obj4 (Authy)
                $obj4->addCurrencyRelatedByIdModification($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Currency objects pre-filled with all related objects except AuthyGroup.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptAuthyGroup(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CurrencyPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Currency) to the collection in $obj2 (Authy)
                $obj2->addCurrencyRelatedByIdCreation($obj1);
                ...
                // Add the $obj1 (Currency) to the collection in $obj3 (Authy)
                $obj3->addCurrencyRelatedByIdModification($obj1);
    ...
    /**
     * Selects a collection of Currency objects pre-filled with all related objects except AuthyRelatedByIdCreation.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of Currency objects pre-filled with all related objects except AuthyRelatedByIdModification.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCurrencyPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \App\map\CurrencyTableMap());
      }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CurrencyPeer::ID_CURRENCY) && $criteria->keyContainsValue(CurrencyPeer::ID_CURRENCY) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CurrencyPeer::ID_CURRENCY);
            $value = $criteria->remove(CurrencyPeer::ID_CURRENCY);
            if ($value) {
                $selectCriteria->add(CurrencyPeer::ID_CURRENCY, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CurrencyPeer::ID_CURRENCY, (array) $values, Criteria::IN);
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($obj->isNew() || $obj->isColumnModified(CurrencyPeer::NAME))
            $columns[CurrencyPeer::NAME] = $obj->getName();
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(CurrencyPeer::DATABASE_NAME);
        $criteria->add(CurrencyPeer::ID_CURRENCY, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CurrencyPeer::DATABASE_NAME);
            $criteria->add(CurrencyPeer::ID_CURRENCY, $pks, Criteria::IN);
