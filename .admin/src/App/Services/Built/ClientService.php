...
class ClientService
{
    ...
    public function getResponse()
    {
        ...
        switch($this->request['a']){
            ...
            case 'delete':
                ...
                **/
                case 'Billing':
                    $this->content = $this->Form->getBillingList($this->request['i'], $this->request);
                break;
    ...
    */
    ...
    public function deleteOne()
    {
        ...
        $obj = ClientQuery::create()->findPk(json_decode($this->request['i']));
            ...
            if($obj->countBillings()){
                $error = handleNotOkResponse(_("This entry cannot be deleted. It is in use in ")." 'Billing'. ", '', true,'Client'); die( $error['onReadyJs'] );
            }
    ...
    public function saveUpdate()
    {
        ...
        $data['i'] = ( $data['IdClient'] ) ? $data['IdClient'] : $this->request['i'];
    ...
    */
    ...
    {
        $this->Client['request'] = $this->request;
        $this->Client['parentId'] = $this->request['data']['ip'];
