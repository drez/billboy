            ...
            **/
            ...
            if(!$this->setReadOnly && !$this->setListRemoveDelete){
                if($_SESSION[_AUTH_VAR]->hasRights('BillingLine', 'd')){
                    $this->canDelete = htmlLink("<i class='ri-delete-bin-7-line'></i>", "Javascript:", "class='ac-delete-link' j='deleteBillingLine' ");
                }
            }
...
$this->fields['BillingLine']['WorkDate']['html'] = stdFieldRow(_("Date"), input('date', 'WorkDate', $dataObj->getWorkDate(), "  j='date' autocomplete='off' placeholder='YYYY-MM-DD' size='10'  s='d' class='' title='Date'"), 'WorkDate', "", $this->commentsWorkDate, $this->commentsWorkDate_css, '', ' ', 'no');
