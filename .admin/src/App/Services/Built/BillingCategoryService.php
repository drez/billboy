...
class BillingCategoryService
{
    ...
    */
    public function getApiResponse()
    {
        ...
        $Api = new Api('BillingCategory', $this);
    ...
    public function deleteOne()
    {
        ...
        $obj = BillingCategoryQuery::create()->findPk(json_decode($this->request['i']));
            ...
            if($obj->countBillingLines()){
                $error = handleNotOkResponse(_("This entry cannot be deleted. It is in use in ")." 'Entries'. ", '', true,'Category billing'); die( $error['onReadyJs'] );
            }
    ...
    public function saveUpdate()
    {
        ...
        $data['i'] = ( $data['IdBillingCategory'] ) ? $data['IdBillingCategory'] : $this->request['i'];
        $data['ip'] = urldecode($this->request['data']['ip']);
        $data['pc'] = urldecode($this->request['data']['pc']);
        $this->BillingCategory['request'] = $this->request;
    ...
    */
    ...
    {
        $this->BillingCategory['request'] = $this->request;
        $this->BillingCategory['parentId'] = $this->request['data']['ip'];
